...
@Getter
public class VersionReply extends Message {
    static final public String name = "VersionReply";
     ...
     */
    public VersionReply() {
        super(name, VersionProtocol.protocolName,Message.Type.Reply);
    }
     ...
     */
    public VersionReply(Document doc) throws InvalidMessage {
        super(name,VersionProtocol.protocolName,Message.Type.Reply,doc); // really just testing the name, otherwise nothing more to test
        this.doc=doc;
